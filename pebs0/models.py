...
class Player(BasePlayer):
	...
	tpay = models.FloatField()
	tpay2 = models.FloatField()
	extrat = models.FloatField()
	payafdon = models.FloatField()
	paywwf = models.FloatField()
	paymeer = models.FloatField()
	paytafel = models.FloatField()


	def savepay(self):
		if str(type(self.spendeWWF))=="<class 'float'>":
			if self.spendeWWF>0:
				self.participant.vars["swwf"]=self.spendeWWF
		if str(type(self.spendeMeerPlastik))=="<class 'float'>":
			if self.spendeMeerPlastik>0:
				self.participant.vars["smeer"]=self.spendeMeerPlastik
		if str(type(self.spendeMannTafel))=="<class 'float'>":
			if self.spendeMannTafel>0:
				self.participant.vars["staf"]=self.spendeMannTafel
		self.tpay = float(round(self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"]+self.participant.vars["payla"],2))
		self.tpay2 = float(round(self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"]+ self.participant.vars["ptoday"] + self.participant.vars["scored"]+self.participant.vars["payla"],2 ))
		self.extrat = float(round(self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"]+ self.participant.vars["scored"]+self.participant.vars["payla"],2 ))
		self.payafdon=round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*((100-self.participant.vars["swwf"]-self.participant.vars["smeer"]-self.participant.vars["staf"])/100),2)
		self.paywwf=round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["swwf"]/100),2)
		self.paymeer=round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["smeer"]/100),2)
		self.paytafel=round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["staf"]/100),2)
	...
	def vars_for_template(self):	
			...
			'pwork': self.participant.vars["paywork"],
			...
			'corr':self.corr,
			'wotot':self.round_number-4,
			'showpay':self.participant.vars["showpay"],
			'totpay': round(self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"],2), 
			'totpay2': round(self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"]+ self.participant.vars["ptoday"] + self.participant.vars["scored"] + self.participant.vars["payla"],2 ),
			'extot': round(self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"]+ self.participant.vars["scored"] + self.participant.vars["payla"],2 ),
			'own': round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*((100-self.participant.vars["swwf"]-self.participant.vars["smeer"]-self.participant.vars["staf"])/100),2),
			'wf':round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["swwf"]/100),2),
			'me':round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["smeer"]/100),2),
			'ta':round((self.participant.vars["payoff1"] + self.participant.vars["pex"] + self.participant.vars["belbo"] + self.participant.vars["pggpay"] + self.participant.vars["scored"] + self.participant.vars["payla"])*(self.participant.vars["staf"]/100),2),
